      ...
      <div className="w-full max-w-md space-y-4 rounded-xl border border-neutral-200 bg-neutral-100 p-6 shadow-lg dark:border-neutral-700 dark:bg-neutral-800">
                ...
                {seats?.map((s) => (
                  ...
                  >
                    <span className="flex items-center gap-2">
                      <span className={s.connected ? 'text-purple-500 dark:text-purple-400' : 'text-red-700 dark:text-red-400'}>
                        ●
                      </span>
        ...
        {phase === 'idle' && (
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            <div>
              <label htmlFor="player-name" className="mb-1 block text-xs uppercase tracking-wide text-gray-500/70 dark:text-gray-400/70">
                Your name
              </label>
              <input
                id="player-name"
            ...
            <div>
              <label htmlFor="room-code" className="mb-1 block text-xs uppercase tracking-wide text-gray-500/70 dark:text-gray-400/70">
                Room code (to join)
              </label>
              <input
                id="room-code"
